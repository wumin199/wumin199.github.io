...
|XMind思维导图|[ZEN破解版](https://pan.baidu.com/s/1xTKj_GXpNkrwdmjiNP3zKw), 提取码：5axy |1. 绿色软件，直接解压后点击`XMind ZEN`即可使用，有弹窗提示更新则不要进行更新<br>2. 可以解压后放到C盘下，或者`C:\\Program Files`下，然后发送快捷键到桌面。<br>3. 如果解压到`C:\\Program Files (x86)`，打开软件会找不到模板，打开其他xmind文件会崩溃||
